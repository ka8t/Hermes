...
# (issue #66, part of #65) — the one piece of #10's original
...
#
# Callable standalone, or from provision.sh (#67) as part of the guided
...
echo ""
echo "The web dashboard (http://127.0.0.1:9119) needs a username and password"
echo "so it isn't wide open to anyone on your network."
echo ""
...
# argument after -i; GNU sed (the VPS's linux-x86_64-vps/scripts/configure-env.sh)
# doesn't take one. Not portable between the two — this is the macOS copy.

...
# build tag like llama.cpp) for macOS Apple Silicon into
# ./vendor/llama-swap. See ../../shared/prebuilt-binaries.md.
...
if [ -z "${URL}" ]; then
  echo "Could not find a darwin_arm64 asset in the latest llama-swap release." >&2
  exit 1
fi

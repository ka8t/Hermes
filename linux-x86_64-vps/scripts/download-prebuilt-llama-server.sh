#!/usr/bin/env bash
# Downloads the latest official prebuilt llama.cpp binary for Linux x86-64
# (CPU only, auto-dispatches to the best microarchitecture at startup) into
# ./vendor/llama.cpp-prebuilt. Only needed for the native (no-Docker)
# alternative — the Docker path gets llama-server bundled inside
# ghcr.io/mostlygeek/llama-swap:cpu instead. See ../../shared/prebuilt-binaries.md.

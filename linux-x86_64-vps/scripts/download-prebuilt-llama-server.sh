...
# ./vendor/llama.cpp-prebuilt. See ../../shared/prebuilt-binaries.md for
# what's actually inside it. This is the no-Docker alternative to the
# llama-server container in docker-compose.yml — see README.md.

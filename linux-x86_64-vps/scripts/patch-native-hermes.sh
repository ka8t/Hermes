...
#
# Mirrors ../../macos-arm64/scripts/patch-native-hermes.sh exactly (this
# file is platform-agnostic — same $HOME/.hermes layout on both) — added
# 2026-09-07 because linux-x86_64-vps had no equivalent at all: a native
# VPS deployment previously got none of #48/#50/#75/#76, unlike VPS Docker
# mode (which gets them via the shared image) or macOS native (which has
# had this script since #48).
#
